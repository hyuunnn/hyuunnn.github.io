...
* <a href="https://jojoldu.tistory.com/609">자바 공화국</a>, <a href="https://jojoldu.tistory.com/687">다른 언어로 성장하기</a>
  ...
  * 특히 이번에 장고 프레임워크를 공부하면서 MTV(Model-Template-View) - MVC와 유사한 패턴, 지연 로딩, N+1 문제, DTO(Data Transfer Object) 역할을 수행하는 serializer 코드 등등 키워드들이 이전에 자바 스프링을 공부하면서 배웠던 내용이라서 수월하게 공부할 수 있었다.
