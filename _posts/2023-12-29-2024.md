...
* WPF를 처음 사용해보고 입문하고 싶다면 읽어볼만한 책이다.
* WPF는 새로운 개념이 아니다. 안드로이드 개발할 때 xml에서 UI를 그렸던 것을 생각하면 된다.
  * 디자인 코드와 개발 코드를 분리하는 것
* 책 제목은 일주일 만에 배우기인데 책이 두껍지 않아서 마음만 먹으면 금방 정독할 수 있다.
