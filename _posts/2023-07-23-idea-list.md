...
* <a href="https://github.com/EricZimmerman/RegistryPlugins">Registry Explorer Plugin</a> 개발
    ...
    * `Windows App` 플러그인 수정
        ...
        * `SOFTWARE`에 존재하는 `Repository` 경로 설정도 미스가 있는 것 같다. `Software\classes\~`로 되어있는데 `Software`를 제거해야 한다. - <a href="https://github.com/AndrewRathbun/VanillaWindowsRegistryHives">VanillaWindowsRegistryHives</a> 활용하기
